...
from routers import (
    ...
    web_pages, documents, discovery, quarantine, entities, location, projects, finance, system_health, source_history, datasets
)
...
logger.info("All 23 API routers registered successfully")
