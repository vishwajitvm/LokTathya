...
* **Public Domain Affidavits**: We disclose public representative information that is legally mandated for public interest (e.g., assets, liabilities, and educational profiles).
* **Private PII Redacted**: We strictly redact personal contact numbers, private bank account numbers, tax identification codes (e.g. PAN numbers), and private residential addresses.
